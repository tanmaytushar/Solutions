...
/*
The idea is lets say you know the best possible jump for i + 1 then 
for index i if the max(0->i) > min(i+1->n) then your answer can be derived as 
max(a[i],dp[i+1],max(0->i))
*/
